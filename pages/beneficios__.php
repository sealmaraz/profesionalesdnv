...
<section class="container_Propio">
    ...
    <div thumbsSlider="" class="swiper mySwiper3">
      <div class="swiper-wrapper">
        ...
        foreach ($images as $image) {
          echo '<div class="swiper-slide"><img style="height:400px" src="../img/banner_departamentos/' . $image . '" alt="' . $image . '"></div>';
        }
        ?>
      </div>
      <div class="swiper-button-next"></div>
  ...
  <article class="detalle_subsidio">
    ...
    <?php
          ...
          $images = array_diff($images, array('..', '.'));
          foreach ($images as $image) {
            echo '<div class="img-grid_destinos"><img src="../img/banner_destinos/' . $image . '" alt="' . $image . '"></div>';
          }
          ?>
    </div>
    <div class="swiper-pagination"></div>
