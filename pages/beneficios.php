...
<section class="banner_principal glide">
  <div class="banner_sorteos  glide__track" data-glide-el="track">
    <ul class="glide__slides">
      ...
      <li class="glide__slide banner__1">
        <a href="#subsidio"><img class="banner__img wait-loading" src="../img/banner_beneficios/subsidioNacimiento.png" alt="" /></a>
      </li>

      <li class="glide__slide banner__1">
        <a href="#bonoFidelidad"><img class="banner__img wait-loading" src="../img/banner_beneficios/bonoFidelidad.png" alt="" /></a>
      </li>

      <li class="glide__slide banner__1">
        <img class="banner__img wait-loading" src="../img/banner_beneficios/regaloBienvenida.png" alt="" />
      </li>

      <li class="glide__slide banner__1">
        <img class="banner__img wait-loading" src="../img/banner_beneficios/bonoMensual.png" alt="" />
      </li>

      <li class="glide__slide banner__1">
        <a href="#alojamiento"><img class="banner__img wait-loading" src="../img/banner_beneficios/alojamientoPropio.png" alt="" /></a>
      </li>
      <li class="glide__slide banner__1">
        <a href="#descuentosHoteles"><img class="banner__img wait-loading" src="../img/banner_beneficios/descuentoHoteles.png" alt="" /></a>
      </li>

      <li class="glide__slide banner__1">
        <a href="https://www.ameport.org.ar/page/default" target="_blank"><img class="banner__img wait-loading" src="../img/banner_beneficios/convenioAmeport.png" alt="" /></a>
      </li>
      ...
      <li class="glide__slide banner__1">
        <img class="banner__img wait-loading" src="../img/banner_beneficios/regaloExclusivo.png" alt="" />
      </li>
  ...
  <div class="glide__arrows" data-glide-el="controls">
    <button class="glide__arrow glide__arrow--left" data-glide-dir="<">
      <iconify-icon class="iconify_chevron" icon="ic:round-chevron-left"></iconify-icon>
    </button>
    <button class="glide__arrow glide__arrow--right" data-glide-dir=">">
      <iconify-icon class="iconify_chevron" icon="ic:round-chevron-right"></iconify-icon>
    </button>
  </div>
