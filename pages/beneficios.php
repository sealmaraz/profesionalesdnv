...
<section class="main_principal glide">
  <div class="banner_sorteos glide__track" data-glide-el="track">
    <ul class="glide__slides">
      ...
      <li class="glide__slide banner__1">
        <img class="banner__img" src="../img/banner_beneficios/beneficiosTuristicos.png" alt="" />
      </li>
...
<section class="container">
  ...
  <article class="detalle_departamento">
    <!-- Para evitar ver la carg de las imagenes -->
    <div class="loading loading--show"><iconify-icon icon="eos-icons:bubble-loading" width="50" height="50"></iconify-icon></iconify-icon></div>
    <!--Carousel-->
    <div class="carousel carousel--show">
