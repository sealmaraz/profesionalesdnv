...
<section class="banner_principal glide">
  <div class="banner_sorteos  glide__track" data-glide-el="track">
    <ul class="glide__slides">
      <li class="glide__slide banner__1">
        <a href="#subsidio"><img class="banner__img wait-loading" src="../img/banner_beneficios/subsidioMatrimonio.png" alt="" /></a>
      </li>
          ...
          <li class="glide__slide banner__1">
            <a href="#subsidio"
              ><img
                class="banner__img"
                src="../img/banner_beneficios/subsidioNacimiento.png"
                alt=""
            /></a>
          </li>

          <li class="glide__slide banner__1">
            <a href="#bonoFidelidad"
              ><img
                class="banner__img"
                src="../img/banner_beneficios/bonoFidelidad.png"
                alt=""
            /></a>
          </li>
          ...
          <li class="glide__slide banner__1">
            <img
              class="banner__img"
              src="../img/banner_beneficios/regaloBienvenida.png"
              alt=""
            />
          </li>
          ...
          <li class="glide__slide banner__1">
            <img
              class="banner__img"
              src="../img/banner_beneficios/bonoMensual.png"
              alt=""
            />
          </li>
          ...
          <li class="glide__slide banner__1">
            <a href="#alojamiento"
              ><img
                class="banner__img"
                src="../img/banner_beneficios/alojamientoPropio.png"
                alt=""
            /></a>
          </li>
          <li class="glide__slide banner__1">
            <a href="#descuentosHoteles"
              ><img
                class="banner__img"
                src="../img/banner_beneficios/descuentoHoteles.png"
                alt=""
            /></a>
          </li>

          <li class="glide__slide banner__1">
            <a href="https://www.ameport.org.ar/page/default" target="_blank"
              ><img
                class="banner__img"
                src="../img/banner_beneficios/convenioAmeport.png"
                alt=""
            /></a>
          </li>
          ...
          <li class="glide__slide banner__1">
            <img
              class="banner__img"
              src="../img/banner_beneficios/beneficiosTuristicos.png"
              alt=""
            />
          </li>
          ...
          <li class="glide__slide banner__1">
            <img
              class="banner__img"
              src="../img/banner_beneficios/regaloExclusivo.png"
              alt=""
            />
          </li>
          ...
          <li class="glide__slide banner__1">
            <img
              class="banner__img"
              src="../img/banner_beneficios/asesoriaGremial.png"
              alt=""
            />
          </li>
        </ul>
    ...
    <section class="container">
      ...
      <article class="detalle_departamento">
          ...
          <div class="glider-contain">
            ...
            <div class="glider1">
              <div class="banner__1">
                <img
                  class="banner__img1"
                  src="../img/banner_departamentos/depto__1.jpeg"
                  alt=""
                />
              </div>
              <div class="banner__1">
                <img
                  class="banner__img1"
                  src="../img/banner_departamentos/depto__2.jpeg"
                  alt=""
                />
              </div>
              <div class="banner__1">
                <img
                  class="banner__img1"
                  src="../img/banner_departamentos/depto__3.jpeg"
                  alt=""
                />
              </div>
              <div class="banner__1">
                <img
                  class="banner__img1"
                  src="../img/banner_departamentos/depto__4.jpeg"
                  alt=""
                />
              </div>
              <div class="banner__1">
                <img
                  class="banner__img1"
                  src="../img/banner_departamentos/depto__6.jpeg"
                  alt=""
                />
              </div>
              <div class="banner__1">
                <img
                  class="banner__img1"
                  src="../img/banner_departamentos/depto__7.jpeg"
                  alt=""
                />
              </div>
              <div class="banner__1">
                <img
                  class="banner__img1"
                  src="../img/banner_departamentos/depto__8.jpeg"
                  alt=""
                />
              </div>
              <div class="banner__1">
                <img
                  class="banner__img1"
                  src="../img/banner_departamentos/depto_10.jpeg"
                  alt=""
                />
              </div>
              <div class="banner__1">
                <img
                  class="banner__img1"
                  src="../img/banner_departamentos/depto_11.jpeg"
                  alt=""
                />
              </div>
              <div class="banner__1">
                <img
                  class="banner__img1"
                  src="../img/banner_departamentos/depto_12.jpeg"
                  alt=""
                />
              </div>
              <div class="banner__1">
                <img
                  class="banner__img1"
                  src="../img/banner_departamentos/depto_13.jpeg"
                  alt=""
                />
              </div>
              <div class="banner__1">
                <img
                  class="banner__img1"
                  src="../img/banner_departamentos/depto_14.jpeg"
                  alt=""
                />
              </div>
              <div class="banner__1">
                <img
                  class="banner__img1"
                  src="../img/banner_departamentos/depto_15.jpeg"
                  alt=""
                />
              </div>
              <div class="banner__1">
                <img
                  class="banner__img1"
                  src="../img/banner_departamentos/depto_16.jpeg"
                  alt=""
                />
              </div>
              <div class="banner__1">
                <img
                  class="banner__img1"
                  src="../img/banner_departamentos/depto_17.jpeg"
                  alt=""
                />
              </div>
              <div class="banner__1">
                <img
                  class="banner__img1"
                  src="../img/banner_departamentos/depto_18.jpeg"
                  alt=""
                />
              </div>
              <div class="banner__1">
                <img
                  class="banner__img1"
                  src="../img/banner_departamentos/depto_19.jpeg"
                  alt=""
                />
              </div>
              <div class="banner__1">
                <img
                  class="banner__img1"
                  src="../img/banner_departamentos/depto_20.jpeg"
                  alt=""
                />
              </div>
            </div>
        ...
        <div class="glider_text">
          <span class="title_subsidio" style="text-align: center;"
            >Para tu comodidad se encuentran ubicados estratégicamente frente a
            Casa Central en AVDA. PTE. JULIO A. ROCA 771 - CABA
          </span>
          <a
            class="link_protocolo"
            href="../docs/Protocolo_uso_departamentos_CABA-010124.pdf"
            target="_blank"
            ><iconify-icon icon="typcn:arrow-right-thick"></iconify-icon>
            Condiciones de Uso y Reserva</a
          >
          <br />
          <span class="text_subsidio"
            >Podrás hacer uso de todos los amenities: pileta, lavadero, parrilla
            y gimnasio, respetando las indicaciones del edificio.</span
          >
          <br />
          <span class="text_subsidio"
            >Para reservas o consultas comunicate al whatsapp
            <a
              class="wsp_reserva"
              style="font-size: large;"
              href="https://api.whatsapp.com/send/?phone=5491127723511"
              target="_blank"
              ><iconify-icon
                class="icon_reserva"
          ...
          <br />
          <span class="text_subsidio"
            >Datos de cuenta para pago de estadía:</span
          >
          <span class="text_subsidio" style="color: var(--primary-color-solid);"
            >CBU: 0110010540001013410080</span
          >
          <span class="text_subsidio" style="color: var(--primary-color-solid);"
            >Alias: RESERVAS.DPTOS.AP</span
          >
          <span class="text_subsidio"
            >Se recomienda copiar y pegar los datos previos.</span
          >
        </div>
      </article>
      <h2 class="linea title_alojamiento" id="subsidio">
        <span class="t_alojamiento"
          >Subsidio por Casamiento, Nacimiento o Adopción</span
        >
      </h2>
      <article class="detalle_subsidio">
        ...
        <a
          class="link_protocolo"
          href="../docs/SUBSIDIOS_POR_CASAMIENTO_Y_NACIMIENTO_O_ADOPCIÓN.pdf"
          target="_blank"
          ><iconify-icon icon="typcn:arrow-right-thick"></iconify-icon>
          Reglamento de ortorgamiento</a
        >
        <span class="text_subsidio"
          >Es un trámite sencillo y puedes canalizarlo a través del Delegado de
        ...
        <ul>
          <li class="lista_beneficio">
            ...
            ></iconify-icon
            ><span class="text_subsidio"
              >Certificado de Matrimonio legalizada</span
            >
          </li>
          <li class="lista_beneficio">
            <iconify-icon
            ...
            ></iconify-icon
            ><span class="text_subsidio"
              >Sentencia firme de adopción plena o copia autenticada del
              oficio</span
            >
          </li>
          <li class="lista_beneficio">
            ...
            ></iconify-icon
            ><span class="text_subsidio"
              >Nota solicitando el beneficio firmada por el afiliado</span
            >
          </li>
          <li class="lista_beneficio">
            <iconify-icon
              ...
              icon="healthicons:i-documents-accepted-outline"
            ></iconify-icon
            ><span class="text_subsidio">Fotocopia de Recibo de Sueldo</span>
          </li>
          <li class="lista_beneficio">
            <iconify-icon
              style="font-size: var(--font-small);"
              icon="healthicons:i-documents-accepted-outline"
            ></iconify-icon
            ><span class="text_subsidio">Constancia de CBU</span>
          </li>
          <li class="lista_beneficio">
            <iconify-icon
              style="font-size: var(--font-small);"
              icon="healthicons:i-documents-accepted-outline"
            ></iconify-icon
            ><span class="text_subsidio">Fotocopia de DNI</span>
          </li>
        </ul>
      </article>
      ...
      <article class="detalle_subsidio">
        ...
        <a
          class="link_protocolo"
          href="../docs/Protocolo_Bono_fidelidad_270421.pdf"
          target="_blank"
          ><iconify-icon icon="typcn:arrow-right-thick"></iconify-icon>
          Protocolo Bono Fidelidad</a
        >
        <span class="text_subsidio"
          >Es un reconocimiento al afiliado que mantuvo de forma consecutiva y
        ...
        <br />
        <span class="text_subsidio"
          >El monto del beneficio al afiliado se determinará de acuerdo a la
        ...
        <ul>
          <li class="lista_beneficio">
            ...
            ></iconify-icon
            ><span class="text_subsidio"
              >Más de 10 años y hasta 14 años 11 meses y 30 días de antigüedad
          ...
          <li class="lista_beneficio">
            ...
            ></iconify-icon
            ><span class="text_subsidio"
              >Más de 15 años y hasta 19 años 11 meses y 30 días de antigüedad
          ...
          <li class="lista_beneficio">
            ...
            ></iconify-icon
            ><span class="text_subsidio"
              >Más de 20 años y hasta 24 años 11 meses y 30 días de antigüedad
          ...
          <li class="lista_beneficio">
            ...
            ></iconify-icon
            ><span class="text_subsidio"
              >Más de 25 años de antigüedad en la Asociación:
    ...
    <span class="text_subsidio" style="text-align: justify;"><iconify-icon style="font-size: var(--font-xsmall);" icon="healthicons:i-documents-accepted-outline"></iconify-icon>Ingresa a los sitios y determina cuál se adapta más a tus
      ...
      <article class="detalle_convenioHoteles">
        <div class="hotel">
          ...
          <a
            class="link_protocolo"
            href="https://hotelav.com.ar/es/reservas"
            target="_blank"
            ><iconify-icon icon="typcn:arrow-right-thick"></iconify-icon
            ><span>Realiza aquí tu reserva</span></a
          >
        ...
        <div class="hotel">
          ...
          <a
            class="link_protocolo"
            href="https://www.centuriabuenosaireshotel.com/"
            target="_blank"
            ><iconify-icon icon="typcn:arrow-right-thick"></iconify-icon
            ><span>Realiza aquí tu reserva</span></a
          >
          ...
          <div class="tarifas text_subsidio">
            ...
            <p style="font-weight: 600;">
              ...
              cobrará la primera noche de penalidad. <br /><u
                >*Salidas Imprevistas</u
              >: El huésped debe notificar la salida anticipada 48 horas antes
        ...
        <div class="hotel">
          <span class="title_hotel"
            >HOTEL UTHGRA DE LAS LUCES BUENOS AIRES</span
          >
          <a
            class="link_protocolo"
            href="http://www.uthgradelasluces.com.ar/index.php?n1=home"
            target="_blank"
            ><iconify-icon icon="typcn:arrow-right-thick"></iconify-icon
            ><span>Realiza aquí tu reserva</span></a
          >
